...
// Adjusted version of:
// https://github.com/flutter/flutter/blob/master/packages/flutter/lib/src/material/tabs.dart
...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _TabBarNoRippleState tabBar;
...
class TabBarNoRipple extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  _TabBarNoRippleState createState() => _TabBarNoRippleState();
}

class _TabBarNoRippleState extends State<TabBarNoRipple> {
  ...
  @override
  void didUpdateWidget(TabBarNoRipple oldWidget) {
